...
<h3>Add New Image</h3>
 ...
 <label for="img_title">Title of File:</label><input type="text" name="img_title" id="img_title"><br>
 <label for="img_desc">Description of File:</label><input type="text" name="img_desc" id="img_desc"><br>
